...
<input type="hidden" id="session_id" value="<?php echo e(Session::get('role_id') ?? ''); ?>">
 <div class="content-wrapper">
    ...
    <div class="card card-outline card-orange">
        ...
        <?php if(Session::get('role_id') !== 3): ?>
          <a href="<?php echo e(url('hourly/hw/add')); ?>" class="btn btn-primary  btn-sm"><i class="fa fa-plus"></i> Hourly Homework </a>
        <?php else: ?>
        ...
        <?php if(Session::get('role_id') == 1): ?>
         <form id="quickForm" action="<?php echo e(url('hourly/hw/view')); ?>" method="post" >
                        <?php echo csrf_field(); ?> 
                    <div class="row m-2">
        ...
        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline ">
          ...
          <tr role="row">
              ...
              <?php if(!empty($data)): ?>
                ...
                <tr class="<?php echo e(( 1 == $item['view_status'] ) ? 'bg-warning' : ''); ?>"> 
                    <td><?php echo e($i++); ?></td>
                    ...
                    <td>
                        <button data-id='<?php echo e($item->id); ?>' data-homework_date='<?php echo e($item->homework_date); ?>' data-submission_date='<?php echo e($item->submission_date); ?>' 
                        ...
                        <a href="<?php echo e(url('hourly/homework/details')); ?>/<?php echo e($item->id); ?>" class="btn btn-primary btn-xs ml-3 tooltip1" title1=" Assignments" ><i class="fa fa-reorder"></i></a>    
                        <?php if(Session::get('role_id') == 3): ?>
                            <a href="javascript:;" class="btn btn-success btn-xs ml-3 homeworkId tooltip1" id="homeworkId" data-id='<?php echo e($item->id); ?>' data-bs-toggle="modal" data-bs-target="#uploadModal" title1="Upload Assignment" ><i class="fa fa-upload"></i></a>
                        <?php endif; ?>
                        <?php if(Session::get('role_id') == 3): ?>
                            ...
                            <a href="<?php echo e(url('download_hourly_homework')); ?>/<?php echo e($item['id'] ?? ''); ?>" class="btn btn-danger  btn-xs ml-3 tooltip1" title1="Download Homework" ><i class="fa fa-download"></i></a>
                            <?php endif; ?>
                        <?php endif; ?>                        
                        <?php if(Session::get('role_id') !== 3): ?>
                            
                            <a href="<?php echo e(url('homework/edit',$item->id)); ?>" class="btn btn-success  btn-xs ml-3 tooltip1" title1="Edit Homework" ><i class="fa fa-edit"></i></a>
                            <a href="javascript:;" data-id='<?php echo e($item->id); ?>' data-bs-toggle="modal" data-bs-target="#Modal_id" class="deleteData btn btn-danger  btn-xs ml-3 tooltip1" title1="Delete Homework"><i class="fa fa-trash-o"></i></a>
                        <?php endif; ?>
                    </td>
                </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="modal" id="uploadModal">
              <div class="modal-dialog modal-lg">
                ...
                <form action="<?php echo e(url('upload/hourly/homework')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/master/home_work/hourly/view.blade.php ENDPATH**/ ?>