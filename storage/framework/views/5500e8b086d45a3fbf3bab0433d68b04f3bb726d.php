                ...
                <div class="payroll-hero-inner">
                    <div>
                        ...
                        <div class="payroll-hero-chips">
                            <span class="payroll-chip"><i class="fa fa-list"></i> Total: <?php echo e($loanCount); ?></span>
                            <span class="payroll-chip"><i class="fa fa-check-circle"></i> Active: <?php echo e($activeCount); ?></span>
                            <span class="payroll-chip"><i class="fa fa-archive"></i> Closed: <?php echo e($closedCount); ?></span>
                        </div>
                    </div>
                    <div class="payroll-hero-actions">
                        ...
                        <a href="<?php echo e(url('payroll/staff')); ?>" class="btn btn-sm btn-payroll btn-payroll-light">
            ...
            <div class="card card-outline card-orange payroll-card">
                <div class="card-header payroll-card-header">
                    ...
                    <div class="d-flex flex-wrap align-items-center" style="gap:8px;">
                        <span class="badge-soft">Remaining: <?php echo e(number_format((float)$totalRemaining, 2)); ?></span>
                        <span class="badge-soft">Active: <?php echo e($activeCount); ?></span>
                    </div>
                </div>

                <div class="card-body">
                    <form method="get" action="<?php echo e(url('payroll/staff/loans')); ?>">
                        <div class="d-flex flex-wrap align-items-center payroll-filter" style="gap:10px;">
                            <select name="type" class="form-control form-control-sm" style="min-width:160px;">
                                <option value="" <?php echo e($typeFilter === '' ? 'selected' : ''); ?>>All Types</option>
                                <option value="loan" <?php echo e($typeFilter === 'loan' ? 'selected' : ''); ?>>Loan</option>
                                <option value="advance" <?php echo e($typeFilter === 'advance' ? 'selected' : ''); ?>>Advance</option>
                            </select>
                            ...
                            <select name="status" class="form-control form-control-sm" style="min-width:160px;">
                                ...
                                <option value="closed" <?php echo e($statusFilter === 'closed' ? 'selected' : ''); ?>>Closed</option>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($r['display_unique_id'] ?? $r['unique_id']); ?></td>
                                        <td><?php echo e(ucfirst($r['type'])); ?></td>
                                        <td><?php echo e($r['title'] ?? '-'); ?></td>
                                        <td class="text-right"><?php echo e(number_format($r['principal_amount'], 2)); ?></td>
                                        <td class="text-right"><?php echo e(number_format($r['monthly_deduction'], 2)); ?></td>
                                        <td><?php echo e($r['start']); ?></td>
                                        <td class="text-right"><?php echo e(number_format($r['deducted'], 2)); ?></td>
                                        <td class="text-right"><?php echo e(number_format($r['paid'] ?? 0, 2)); ?></td>
                                        <td class="text-right"><b><?php echo e(number_format($r['remaining'], 2)); ?></b></td>
                                        <td>
                                            <?php if($r['is_active']): ?>
                                        ...
                                        <td>
                                            <button
                                                ...
                                                data-loan-id="<?php echo e($r['id']); ?>"
                                                data-unique-id="<?php echo e($r['unique_id']); ?>"
                                                data-type="<?php echo e($r['type']); ?>"
                                                data-title="<?php echo e($r['title']); ?>"
                                                data-remark="<?php echo e($r['remark'] ?? ''); ?>"
                                                data-amount="<?php echo e($r['principal_amount']); ?>"
                                                data-monthly="<?php echo e($r['monthly_deduction']); ?>"
                                                data-start="<?php echo e($r['start']); ?>"
                                                data-active="<?php echo e($r['is_active'] ? 1 : 0); ?>"
                                            >
                                            ...
                                            <button
                                                ...
                                                data-loan-id="<?php echo e($r['id']); ?>"
                                                data-remaining="<?php echo e($r['remaining']); ?>"
                                            >
                                                <i class="fa fa-credit-card"></i>
                                            </button>
                                            <?php if($r['is_active']): ?>
                                                <form method="post" action="<?php echo e(url('payroll/staff/loans')); ?>" style="display:inline-block;" onsubmit="return confirm('Close this loan/advance?');">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="action" value="close_loan">
                                                    <input type="hidden" name="loan_id" value="<?php echo e($r['id']); ?>">
...
<div class="modal fade payroll-modal" id="loanAddModal" tabindex="-1" role="dialog" aria-labelledby="loanAddModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="post" action="<?php echo e(url('payroll/staff/loans')); ?>">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="unique_id" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $staffList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e('USR-' . $s->id); ?>">
                                            <?php echo e(trim(($s->first_name ?? '').' '.($s->last_name ?? ''))); ?> (<?php echo e(trim((string)($s->attendance_unique_id ?? '')) !== '' ? $s->attendance_unique_id : ('USR-' . $s->id)); ?>)
                                        </option>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/payroll/staff_loans.blade.php ENDPATH**/ ?>