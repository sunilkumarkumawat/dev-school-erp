...
unset($__errorArgs, $__bag); ?>                    			
                        ...
                        <div class="col-md-12">
                            <div class="form-group mt-2">
                                ...
                                <input type="checkbox"  id="refund_fees_value" value="yes" onchange="updateRefundFees(this)" >
                            </div>
                    	</div>    
                    ...
                    <div class="col-md-12">
                       <table id="example1" class="table table-bordered table-striped dataTable dtr-inline padding_table">
                          ...
                          <tr role="row">
                              ...
                              <th><?php echo e(__('Fees Refund')); ?></th>
                          ...
                          <?php if(!empty($dataview)): ?>
                               ...
                               <?php $__currentLoopData = $dataview->where('fees_type', 'full'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                        ...
                                        <td><?php echo e($item['fees_refund'] ?? ''); ?></td>
                                        
                                        <td>
                                            
                                            <a href="<?php echo e(url('feesGroupEdit')); ?>/<?php echo e($item['id'] ?? ''); ?>" class="btn btn-primary  btn-xs tooltip1 <?php echo e(Helper::permissioncheck(11)->edit ? '' : 'd-none'); ?>" title1="Edit"><i class="fa fa-edit"></i></a> 
                                           
                                            <a href="javascript:;" data-id='<?php echo e($item['id']); ?>' data-bs-toggle="modal" data-bs-target="#Modal_id" class="deleteData btn btn-danger btn-xs ml-3 tooltip1 <?php echo e(Helper::permissioncheck(11)->delete ? '' : 'd-none'); ?>" title1="delete"><i class="fa fa-trash-o"></i></a>
...
<script>
    ...
    // Update hidden input to send value "yes" or "no"
    if (checkbox.checked) {
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/fees/fees/feesGroup.blade.php ENDPATH**/ ?>