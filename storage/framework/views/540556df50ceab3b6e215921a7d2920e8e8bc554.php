                ...
                <form id="quickForm" action="<?php echo e(url('add/exam')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row m-2">
            			...
            			<div class="form-group">
            				<label><?php echo e(__('Exam Term')); ?></label>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/examination/offline_exam/exam/add.blade.php ENDPATH**/ ?>