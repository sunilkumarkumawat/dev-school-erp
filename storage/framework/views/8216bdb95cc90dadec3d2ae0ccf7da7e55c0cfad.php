                            ...
                            <?php $__currentLoopData = $week; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php else: ?>
                                    <?php
                                        ...
                                        $status = $mark->status ?? $calendarStatus;
                                        $isFuture = $day > $today;
                                        $isBackLocked = !($canBackDateMarking ?? true) && $day < $today;
                                        $isHolidayLocked = $calendarStatus === 'holiday';
                                    ?>
                                    <div class="self-day <?php echo e($status ? 'status-'.$status : 'status-none'); ?> <?php echo e(($isFuture || $isBackLocked || $isHolidayLocked) ? 'disabled' : ''); ?>"
                                         data-date="<?php echo e($day); ?>"
                                         data-status="<?php echo e($status); ?>"
                                         data-in="<?php echo e($mark->in_time ?? ''); ?>"
                                         data-out="<?php echo e($mark->out_time ?? ''); ?>"
                                         title="<?php echo e($isHolidayLocked ? 'Holiday - attendance locked' : ''); ?>">
...
$(function () {
    ...
    function paintCell($cell, mark) {
        ...
        var status = mark && mark.status ? mark.status : (calendarStatusMap[dateKey] || '');
        ...
        if (attendanceType === 1) {
            ...
            $cell.find('.self-day-time').text((inStr || outStr) ? (inStr + (outStr ? ' - ' + outStr : '')) : '');
        }
    }
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dev\resources\views/attendance/self_calendar.blade.php ENDPATH**/ ?>