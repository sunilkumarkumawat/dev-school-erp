                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange mb-0">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-money"></i> &nbsp;<?php echo e(__('Sibling Fee Management')); ?></h3>
                                ...
                                <div class="row m-2">
                                        ...
                                        <div class="form-group">
                                            <label><?php echo e(__('Ledger No')); ?></label> 
                                                 <input type="text" class="form-control" value="<?php echo e($search['ledger_no'] ?? ''); ?>" id="ledger_no" name="ledger_no" placeholder="<?php echo e(__('Type Ledger No.')); ?>">
                                     
                                          
                                            <?php $__errorArgs = ['ledger_no'];
...
<div class="ledger-top-row">
    <div class="ledger-top-left">
        <p>
            ...
            <?php echo e($students->pluck('first_name')->implode(', ')); ?>

            (AY <?php echo e(Session::get('session_name')); ?>)
        </p>
    </div>
    <div class="ledger-top-right">
        <span class="dues-status">
            <?php if(!empty($outstanding)): ?>
            <?php echo e($outstanding > 0 ? 'Dues Pending' : 'Paid'); ?>
...
<div class="student-card glass-card">
    <div class="student-avatar">
        <img src="<?php echo e(env('IMAGE_SHOW_PATH').'profile/'.$student['image']); ?>"
                                                    onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'default/user_image.jpg'); ?>'">
    </div>

    <h4><?php echo e($student->first_name); ?></h4>
    <p class="student-class"><?php echo e($student->class_name ?? ''); ?></p>

    <div class="fee-section">
        <span>ANNUAL FEE</span>
        <h5>₹<?php echo e(number_format($studentFee)); ?></h5>
    </div>
</div>
...
<?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if(isset($student->paid_records) && $student->paid_records->count()): ?>
    ...
    <table class="payment-table">
        ...
        <?php $__currentLoopData = $student->paid_records ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><?php echo e(date('d M Y', strtotime($pay->created_at))); ?></td>
            <td><?php echo e($pay->receipt_no ?? '-'); ?></td>
            <td><?php echo e($pay->group_name ?? '-'); ?></td>
            <td>₹<?php echo e(number_format($pay->total_amount)); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="summary-row">
    ...
    <span>₹<?php echo e(number_format($annualFees ?? 0)); ?></span>
</div>

<div class="summary-row discount">
    <span>Sibling Discount</span>
    <span> ₹<?php echo e(number_format($totalDiscount ?? 0)); ?></span>
</div>

<div class="summary-total">
    <p>Final Negotiated Amount</p>
    <h3>₹<?php echo e(number_format($finalAmount ?? 0)); ?></h3>
...
<div class="outstanding-amount">
    <h2>₹<?php echo e(number_format($outstanding ?? 0)); ?></h2>
    <span class="pending-text">
          <?php if(!empty($outstanding)): ?>
            <?php echo e($outstanding > 0 ? ' Pending' : 'Paid'); ?>
...
<div class="progress-section">
    ...
    <div class="progress-info">
        ...
        <span><?php echo e($progress ?? 0); ?>%</span>
    </div>
</div>

<form action="<?php echo e(url('ledger/pay')); ?>" method="post">
<?php echo csrf_field(); ?>

<input type="hidden" name="ledger_no" value="<?php echo e($search['ledger_no'] ?? ''); ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/fees/fees_collect/byLedger.blade.php ENDPATH**/ ?>