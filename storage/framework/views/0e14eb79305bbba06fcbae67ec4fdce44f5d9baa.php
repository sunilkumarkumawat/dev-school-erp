...
<ul class="navbar-nav " style="margin-left: 73px; margin-top: 25px;" id="navbar_nav">
    <li class="nav-item dropdown">
      <div class="Display_none_desktop" >
       <h4 class="first-name"><?php echo e(Session::get('first_name') ?? ''); ?> &nbsp &nbsp</h4>
      </div>
    </li>
      <li class="nav-item">
        <a  style="margin:5px;padding:0px;text-align: center; " class="whatsapp_login whatsapp" href="javascript:whatsapp_qrcode_get();" data-toggle="modal" data-target="#whatsapp_login">
           ...
           <i class="nav-icon fa fa-circle" style="color:<?php echo e(Session::get('whatsapp') ? 'green' : 'red'); ?>;font-size:12px;">&nbsp;</i></a>
  </li>
</ul>
...
<?php if(Session::get('role_id') == 1): ?>
      ...
      <div class="Display_none_mobile">
        <form action="<?php echo e(url('changeBranch')); ?>" method="POST">
          ...
          <?php if(Session::get('role_id') != 3): ?>
            ...
            <option value="<?php echo e($branch->id ?? ''); ?> " <?php echo e(( $branch->id == Session::get('branch_id')) ? 'selected' : ''); ?>><?php echo e($branch->branch_name ?? ''); ?> </option>
    ...
    <li class="nav-item dropdown">
      <div class="Display_none_mobile">
        <a href="<?php echo e(URL::current()); ?>" id="refresh" class="refresh_btn" onclick="">Refresh!</a>
      </div>
    </li>
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <div class=" border-bottom d-flex align-items-center p-2 pl-3 ">
         <i class="fa fa-language" aria-hidden="true"></i>
            <form action="<?php echo e(url('changeLang')); ?>" method="POST" class="mb-0">
                <?php echo csrf_field(); ?>
                <select class="selectDesign ml-2" id="lang" name="lang" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($type->value ?? ''); ?>" <?php echo e(session()->get('locale') == $type->value ? 'selected' : ''); ?>>
        ...
        <?php if(Session::get('role_id') == 1): ?>
        <a href="<?php echo e(url('helpAndUpdate')); ?>" class="text-warning dropdown-item border-bottom">
...
/* function fetchBalance() {
    ...
    const firebaseConfig = {
        ...
        measurementId: "<?php echo e(env('FIREBASE_MEASUREMET_ID')); ?>"
    };
...
//alert(token);
    ...
    function saveDeviceToken(token) {
        fetch("<?php echo e(url('/saveDeviceToken')); ?>", {
            method: "POST",
            headers: {
...
const id = "<?php echo e(Session::get('attendance_unique_id')); ?>";
const modal = "<?php echo e(Session::get('modal_name')); ?>" || 'User';
    const user = {
...
</script><?php /**PATH /home/rusofterp/public_html/dev/resources/views/layout/header.blade.php ENDPATH**/ ?>