                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-graduation-cap"></i> &nbsp;<?php echo e(__('Setting Management')); ?></h3>
                   ...
                   <?php if(!empty(Helper::SidebarSubPerm(17))): ?>
                        <?php $__currentLoopData = Helper::SidebarSubPerm(17); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_sidebar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/settings/settings_dashboard.blade.php ENDPATH**/ ?>