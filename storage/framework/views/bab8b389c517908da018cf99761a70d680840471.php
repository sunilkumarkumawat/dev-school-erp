	...
	<section class="content p-1">
		<div class="container-fluid">
            ...
            <div class="alert alert-light border mt-3 mb-0 py-2 small">
                ...
                <input type="file" id="excelFile"  class="form-control"  data-fields='<?php echo json_encode($getAdmissionDatatableFields, 15, 512) ?>'>
...
<script>
let genderList = <?php echo json_encode(DB::table('gender')->whereNull('deleted_at')->pluck('name'), 15, 512) ?>;
window.classMap = <?php echo json_encode($classMap, 15, 512) ?>;
window.classList = Object.keys(window.classMap || {});
let bloodGroupList = <?php echo json_encode(DB::table('blood_groups')->whereNull('deleted_at')->pluck('name'), 15, 512) ?>;

window.admissionFields = <?php echo json_encode($getAdmissionDatatableFields, 15, 512) ?>;
</script>
...
document.getElementById('saveDataBtn').addEventListener('click', function(){
    ...
    fetch(`<?php echo e(url('student-import-save')); ?>`,{
        method:'POST',
        headers:{
    ...
    .then(res => {
        ...
        if(res.status){
            ...
            window.location.href = "<?php echo e(url('admissionView')); ?>";
        } else {
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/students/admission/studentCsvImport.blade.php ENDPATH**/ ?>