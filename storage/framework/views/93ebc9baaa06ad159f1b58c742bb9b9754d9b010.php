                            ...
                            <form method="post" action="<?php echo e(url('attendance/mark?tab=students&date='.$selectedDate.'&class_type_id='.request('class_type_id'))); ?>">
                                ...
                                <div class="ml-auto d-flex align-items-center att-actions" style="gap:10px;">
                                    <div class="att-field">
                                        ...
                                        <input type="time" id="bulkInStudent" class="form-control form-control-sm att-time att-time-input" step="900" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                    </div>
                                    <div class="att-field">
                                        <label>Bulk Check Out</label>
                                        <input type="time" id="bulkOutStudent" class="form-control form-control-sm att-time att-time-input" step="900" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                    </div>
                                    <div class="att-field">
                                        <label>&nbsp;</label>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr class="student-row" data-class="<?php echo e($student->class_type_id); ?>">
                                                    ...
                                                    <td>
                                                        <input type="time" class="form-control form-control-sm att-time-input" name="rows[<?php echo e($i); ?>][in_time]" value="<?php echo e($inTime ? date('H:i', strtotime($inTime)) : ''); ?>" step="900" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                                    </td>
                                                    <td>
                                                        <input type="time" class="form-control form-control-sm att-time-input" name="rows[<?php echo e($i); ?>][out_time]" value="<?php echo e($outTime ? date('H:i', strtotime($outTime)) : ''); ?>" step="900" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                                    </td>
                                                    <td>
                        ...
                        <div class="tab-pane fade <?php echo e(($activeTab ?? 'students') === 'staff' ? 'show active' : ''); ?>" id="staff" role="tabpanel">
                            <form method="post" action="<?php echo e(url('attendance/mark?tab=staff&date='.$selectedDate.'&role_id='.request('role_id'))); ?>">
                                ...
                                <div class="ml-auto d-flex align-items-center att-actions" style="gap:10px;">
                                    <div class="att-field">
                                        <label>Bulk Check In</label>
                                        <input type="time" id="bulkInStaff" class="form-control form-control-sm att-time att-time-input" step="900" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                    </div>
                                    <div class="att-field">
                                        <label>Bulk Check Out</label>
                                        <input type="time" id="bulkOutStaff" class="form-control form-control-sm att-time att-time-input" step="900" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                    </div>
                                    <div class="att-field">
                                        <label>&nbsp;</label>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr class="staff-row" data-role="<?php echo e($member->role_id); ?>">
                                                    ...
                                                    <td>
                                                        <input type="time" class="form-control form-control-sm att-time-input" name="rows[<?php echo e($i); ?>][in_time]" value="<?php echo e($staffIn ? date('H:i', strtotime($staffIn)) : ''); ?>" step="900" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                                    </td>
                                                    <td>
                                                        <input type="time" class="form-control form-control-sm att-time-input" name="rows[<?php echo e($i); ?>][out_time]" value="<?php echo e($staffOut ? date('H:i', strtotime($staffOut)) : ''); ?>" step="900" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                                    </td>
                                                    <td>
                                                        <input type="hidden" name="rows[<?php echo e($i); ?>][unique_id]" value="<?php echo e($uniqueId); ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dev\resources\views/attendance/biometric.blade.php ENDPATH**/ ?>