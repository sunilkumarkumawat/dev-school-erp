                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary flex_items_toggel">
                            <h3 class="card-title"><i class="fa fa-address-book-o"></i> &nbsp;<?php echo e(__('Admission List')); ?>
                            ...
                            <div class="card-tools">
                                ...
                                <a href="<?php echo e(url('admissionAdd')); ?>"
                                    class="btn btn-primary  btn-sm <?php echo e(Helper::permissioncheck(3)->add ? '' : 'd-none'); ?>"><i
                                        class="fa fa-plus"></i><span class="Display_none_mobile"> <?php echo e(__('common.Add')); ?>

                                    </span></a>
                                <a href="<?php echo e(url('studentsDashboard')); ?>" class="btn btn-primary  btn-sm"><i
                                        class="fa fa-arrow-left"></i><span class="Display_none_mobile"> <?php echo e(__('common.Back')); ?> </span></a>
                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo e(url('studentBulkImageUpload')); ?>" method="post"
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="category" name="category">
                                                ...
                                                <option value="OBC" <?php echo e(old('category', $search['category'] ?? ''
                                                    )=='OBC' ? 'selected' : ''); ?>>OBC</option>
                                                <option value="ST" <?php echo e(old('category', $search['category'] ?? '' )=='ST'
                                                    ? 'selected' : ''); ?>>ST</option>
                                                <option value="SC" <?php echo e(old('category', $search['category'] ?? '' )=='SC'
                                                    ? 'selected' : ''); ?>>SC</option>
                                                <option value="BC" <?php echo e(old('category', $search['category'] ?? '' )=='BC'
                                                    ? 'selected' : ''); ?>>BC</option>
                                                <option value="GEN" <?php echo e(old('category', $search['category'] ?? ''
                                                    )=='GEN' ? 'selected' : ''); ?>>GEN</option>
                                                <option value="SBC" <?php echo e(old('category', $search['category'] ?? ''
                                                    )=='SBC' ? 'selected' : ''); ?>>SBC</option>
                                                <option value="Other" <?php echo e(old('category', $search['category'] ?? ''
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select
                                                class="form-control select2 <?php $__errorArgs = ['class_type_id'];
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="<?php echo e($type->id); ?>" <?php echo e(old('class_type_id',
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="status" name="status">
                                                <option value=""><?php echo e(__('common.Select')); ?></option>
                                                <option value="1" <?php echo e(old('status', $search['status'] ?? '' )==1
                                                    ? 'selected' : ''); ?>><?php echo e(__('Continue')); ?></option>
                                                <option value="0" <?php echo e(old('status', $search['status'] ?? '' )==0
                                                    ? 'selected' : ''); ?>><?php echo e(__('Discontinue')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="gender_id" name="gender_id">
                                                ...
                                                <option value="<?php echo e($value->id); ?>" <?php echo e(old('gender_id',
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="admission_type_id"
                                                ...
                                                <option value=""><?php echo e(__('common.Select')); ?></option>
                                                <option value="1" <?php echo e(old('admission_type_id',
                                                    $search['admission_type_id'] ?? '' )==1 ? 'selected' : ''); ?>>Non RTE
                                                </option>
                                                <option value="2" <?php echo e(old('admission_type_id',
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="blood_group" name="blood_group">
                                                ...
                                                <option value="<?php echo e($bloodtype->name); ?>" <?php echo e(old('blood_group',
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="search_type" name="search_type">
                                                <option value=""><?php echo e(__('common.Select')); ?></option>
                                                <option value="first_name" <?php echo e(old('search_type', $search['search_type']
                                                    ?? '' )=='first_name' ? 'selected' : ''); ?>>Name</option>
                                                <option value="admissionNo" <?php echo e(old('search_type', $search['search_type']
                                                    ?? '' )=='admissionNo' ? 'selected' : ''); ?>>Admission No</option>
                                                <option value="father_name" <?php echo e(old('search_type', $search['search_type']
                                                    ?? '' )=='father_name' ? 'selected' : ''); ?>>Father Name</option>
                                                <option value="mother_name" <?php echo e(old('search_type', $search['search_type']
                                                    ?? '' )=='mother_name' ? 'selected' : ''); ?>>Mother Name</option>
                                                <option value="mobile" <?php echo e(old('search_type', $search['search_type']
                                                    ?? '' )=='mobile' ? 'selected' : ''); ?>>Mobile</option>
                                                <option value="aadhaar" <?php echo e(old('search_type', $search['search_type']
                                                    ?? '' )=='aadhaar' ? 'selected' : ''); ?>>Aadhaar</option>
                                                <option value="jan_aadhaar" <?php echo e(old('search_type', $search['search_type']
                                                    ?? '' )=='jan_aadhaar' ? 'selected' : ''); ?>>Jan Aadhaar</option>
                                                <option value="address" <?php echo e(old('search_type', $search['search_type']
...
unset($__errorArgs, $__bag); ?>"
                                                id="name" name="name"
                                                placeholder="<?php echo e(__('Ex. Name, Admission No, Mobile, Aadhaar etc.')); ?>"
                                                value="<?php echo e(old('name', $search['name'] ?? '')); ?>">
                            ...
                            <div class="col-12" style="overflow-x:scroll;">
                                ...
                                <table id="studentList"
                                    ...
                                    <thead id='main_thead' class="bg-primary">
                                        <tr role="row">
                                            <th style="width: 36px;"><?php echo e(__('common.SR.NO')); ?></th>
                                            ...
                                            <th class="text-center"><?php echo e($val); ?></th>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>

                                            <th class="fixed_item bg-primary"><span><?php echo e(__('common.Action')); ?></span>
                                            </th>
                                        </tr>
                                    </thead>
                                        ...
                                        <tr>
                                            <td style="vertical-align: inherit;">
                                                <input type='checkbox' class='checkbox_id'
                                                    ...
                                                    data-name="<?php echo e($item['first_name'] ?? ''); ?> <?php echo e($item['last_name'] ?? ''); ?>"
                                                    data-mobile="<?php echo e($item['mobile'] ?? ''); ?>"
                                                    data-father_name="<?php echo e($item['father_name'] ?? ''); ?>"
                                                    value='<?php echo e($item->id); ?>' style="width: 19px;height: 18px;"> <?php echo e(++$i); ?>
                                            ...
                                            <?php if($val == 'Student Photo'): ?>
                                            <!-- Table Image -->
                                            <td class="text-center">
                                                <img width="50px" height="50px" style="border-radius:3px;padding:1px"
                                                    class="profileImg pointer" data-id="<?php echo e($item['id'] ?? ''); ?>"
                                                    src="<?php echo e(env('IMAGE_SHOW_PATH').'profile/'.$item['image']); ?>"
                                                    onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'default/user_image.jpg'); ?>'">
                                                <div style="display: none;"><?php echo e($item['image'] ?? ''); ?></div>
                                            </td>

                                            <?php elseif($val == 'Student Name'): ?>
                                            <td class="myBtn  editable" style="cursor:pointer;"
                                                data-id="<?php echo e($item->id ?? ''); ?>" data-field='first_name'
                                                data-modal='Admission'><?php echo e($item['first_name'] ?? ''); ?> <?php echo e($item['last_name'] ?? ''); ?></td>
                                            <?php elseif($val == 'Date Of .Birth'): ?>
                                            <td><?php if(!empty($item['dob'])): ?> <?php echo e(date('d-m-Y', strtotime($item['dob'])) ??
                                                ''); ?><?php endif; ?></td>
                                            ...
                                            <?php elseif($val == 'Admission Type(Non RTE)'): ?>
                                            ...
                                            <?php elseif($val == 'Date Of Admission'): ?>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <div class="progress">
                                                    <div class="progress-bar text-dark" role="progressbar"
                                                        aria-valuenow="<?php echo e($paidPercentage ?? 0); ?>" aria-valuemin="0"
                                                        aria-valuemax="100"
                                                        style="width: <?php echo e($paidPercentage ?? 0); ?>%; min-width: 30px;">
                                                        <?php echo e($paidPercentage ?? 0); ?>%
                                                    </div>
                                                </div>
                                            </td>
                                            <?php elseif($val == 'Attendance Unique Id'): ?>

                                            <td><?php echo e($item['attendance_unique_id'] ?? '-'); ?></td>
                                            <?php else: ?>
                                            <?php
                                            $field = $getAdmissionDatatableFields[$val] ?? null;
                                            ?>

                                            <td class="text-center editable" data-id="<?php echo e($item->id ?? ''); ?>"
                                                data-field="<?php echo e($field); ?>" data-modal="Admission">
                                                <?php echo e($field ? ($item[$field] ?? '') : ''); ?>
                                            ...
                                            <td class="fixed_item">
                                                <div class="flex_centered">
                                                    <a href="<?php echo e(url('studentDetail')); ?>/<?php echo e($item['id'] ?? ''); ?>"
                                                        class="<?php echo e(Helper::permissioncheck(3)->view ? '' : 'd-none'); ?>">
                                                        <button class="btn btn-primary  btn-xs tooltip1"
                                                            title1="Student Details"><i
                                                                class="fa fa-arrow-circle-right"></i></button>
                                                    </a>
                                                    <a href="<?php echo e(url('admissionStudentPrint')); ?>/<?php echo e($item->id); ?>"
                                                        target="blank"
                                                        class="<?php echo e(Helper::permissioncheck(3)->print ? '' : 'd-none'); ?>">
                                                        <button class="btn btn-success btn-xs tooltip1"
                                                            title1="Student Admission Print"><i
                                                                class="fa fa-print"></i></button>
                                                    </a>
                                                    <button
                                                        class="btn btn-primary btn-xs openEditModal tooltip1 <?php echo e(Helper::permissioncheck(3)->edit ? '' : 'd-none'); ?>"
                                                    ...
                                                    <a href="javascript:;" data-id='<?php echo e($item->id); ?>'
                                                        ...
                                                        class="deleteData <?php echo e(Helper::permissioncheck(3)->delete ? '' : 'd-none'); ?>">
                ...
                <form action="<?php echo e(url('saveAdmissionDatatableFields')); ?>" method='post'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group clearfix">
                                <div class="icheck-success d-inline">
                                    <input type="checkbox" class="checkbox" id="field_<?php echo e($dataFields ?? ''); ?>"
                                        name='fields[]' <?php echo e(in_array($key, $dataTable) ? 'checked' : ''); ?>
...
<script>
    ...
    const save_url = '<?php echo e(url("imageRotateSave")); ?>';
        ...
        $('#attachment-file').on('change', function (event) {
            ...
            if (file) {
                if (file.type.match('image.*')) {
                    ...
                    $('#img_preview').attr('src', '<?php echo e(env("IMAGE_SHOW_PATH") . "default/6605525.jpg"); ?>');
                }
            }
        });
    });
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/students/admission/view.blade.php ENDPATH**/ ?>