    ...
    <div class="login-card">
        <section class="brand-pane">
            <div class="brand-content">
                <img
                    class="brand-logo"
                    src="<?php echo e(env('IMAGE_SHOW_PATH').'setting/left_logo/'.$setting->left_logo ?? ''); ?>"
                    onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'default/no_image.png'); ?>'"
                    alt="School Logo"
                >

                <h1 class="brand-title"><?php echo e($setting->name ?? 'School ERP'); ?></h1>
        ...
        <section class="form-pane">
            <div class="form-wrap">
                ...
                <p class="footer-note">
                    Copyright <?php echo e(date('Y')); ?> <?php echo e($setting->name ?? 'School ERP'); ?>
...
const APP_BASE_URL = "<?php echo e(url('/')); ?>";
...
<?php /**PATH /home/rusofterp/public_html/dev/resources/views/auth/login.blade.php ENDPATH**/ ?>