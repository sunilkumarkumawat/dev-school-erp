...
<aside class="main-sidebar" id="sidebar">
    <a href="<?php echo e(url('/')); ?>">
        <div class="top_brand_section">
            <img src="<?php echo e(env('IMAGE_SHOW_PATH').'/setting/left_logo/'.$getSetting->left_logo ?? ''); ?>" 
                 alt="" class="brand_img" 
                 onerror="this.src='<?php echo e(env('IMAGE_SHOW_PATH').'default/no_image.png'); ?>'">
            <span class="brand_title"><?php echo e($getSetting->name ?? ''); ?></span>
        </div>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
                <?php $__currentLoopData = $sidebar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li class="nav-item <?php echo e(!empty($submenus) ? 'has-treeview' : ''); ?> <?php echo e($activeSub ? 'menu-open' : ''); ?>">
                        <a href="<?php echo e(!empty($submenus) ? '#' : url($data->url)); ?>" 
                           class="nav-link <?php echo e(url($data->url) == URL::current() ? 'active' : ''); ?>">
                            <i class="nav-icon fa <?php echo e($data->ican ?? ''); ?>"></i>
                            <p>
                                <?php if(Session::get('locale') == 'hi'): ?> 
                                    <?php echo e($data->hindi_name ?? ''); ?> 
                                <?php else: ?> 
                        ...
                        <?php if(!empty($submenus)): ?>
                            <ul class="nav nav-treeview">
                                <?php $__currentLoopData = $subSidebar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(in_array($sub->id, $submenus)): ?>
                                        <li class="nav-item">
                                            <a href="<?php echo e(url($sub->url)); ?>" 
                                               class="nav-link <?php echo e(url($sub->url) == URL::current() ? 'active' : ''); ?>">
                                                <i class="fa fa-circle nav-icon"></i>
                                                <p>
                                                    <?php if(Session::get('locale') == 'hi'): ?> 
                                                        <?php echo e($sub->hindi_name ?? ''); ?> 
                                                    <?php else: ?> 
                                                        <?php echo e($sub->name ?? ''); ?> 
                                                    <?php endif; ?>
                                                </p>
                ...
                <li class="nav-item "> <a href="<?php echo e(url('helpAndUpdate')); ?>" class="nav-link"> 
...
<?php /**PATH /home/rusofterp/public_html/dev/resources/views/layout/sidebar.blade.php ENDPATH**/ ?>