                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-graduation-cap"></i> &nbsp;<?php echo e(__('Qr Code Dashboard')); ?></h3>
                   ...
                   <?php if(!empty(Helper::SidebarSubPerm(25))): ?>
                        <?php $__currentLoopData = Helper::SidebarSubPerm(25); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_sidebar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/students/qrcode_attendance/qrcode_Dashboard.blade.php ENDPATH**/ ?>