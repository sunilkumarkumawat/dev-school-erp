            ...
            <div class="card card-outline card-orange">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content mt-3" id="attendanceTabContent">
                        <div class="tab-pane fade <?php echo e(($activeTab ?? 'students') === 'students' ? 'show active' : ''); ?>" id="students" role="tabpanel">
                            <form method="post" action="<?php echo e(url('attendance/mark?tab=students&date='.$selectedDate.'&class_type_id='.request('class_type_id'))); ?>">
                                ...
                                <select id="studentClassFilter" name="class_type_id" class="form-control form-control-sm select2 att-filter" style="width:220px;">
                                    ...
                                    <input type="hidden" name="class_type_id" id="classFilterInput" value="<?php echo e(request('class_type_id')); ?>">
                                <div class="ml-auto d-flex align-items-center att-actions" style="gap:10px;">
                                    <div class="att-field">
                                        <label>Bulk Check In</label>
                                        <input type="time" id="bulkInStudent" class="form-control form-control-sm att-time att-time-input" step="60" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                    </div>
                                    <div class="att-field">
                                        <label>Bulk Check Out</label>
                                        <input type="time" id="bulkOutStudent" class="form-control form-control-sm att-time att-time-input" step="60" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                    </div>
                                    <div class="att-field">
                                        <label>&nbsp;</label>
                                        <button class="btn btn-sm btn-outline-secondary" type="button" id="applyBulkTimeStudent" <?php if($holidayLock): ?> disabled <?php endif; ?>>Apply Time</button>
                                    </div>
                                    <div class="att-field">
                                        <label>Bulk Status</label>
                                        <select id="bulkStatusStudent" class="form-control form-control-sm att-filter" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                    ...
                                    <div class="att-field">
                                        <label>&nbsp;</label>
                                        <button class="btn btn-sm btn-outline-secondary" type="button" id="applyBulkStudent" <?php if($holidayLock): ?> disabled <?php endif; ?>>Apply Status</button>
                                    </div>
                                    <div class="att-field">
                                        <label>&nbsp;</label>
                                    ...
                                    <table class="table table-bordered att-table" id="studentsTable">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                <tr class="student-row" data-class="<?php echo e($student->class_type_id); ?>">
                                                    <td><?php echo e($uniqueId); ?></td>
                                                    <td><?php echo e(trim($student->first_name . ' ' . $student->last_name)); ?></td>
                                                    <td>
                                                        <input type="time" class="form-control form-control-sm att-time-input" name="rows[<?php echo e($i); ?>][in_time]" value="<?php echo e($inTime ? date('H:i', strtotime($inTime)) : ''); ?>" step="60" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                                    </td>
                                                    <td>
                                                        <input type="time" class="form-control form-control-sm att-time-input" name="rows[<?php echo e($i); ?>][out_time]" value="<?php echo e($outTime ? date('H:i', strtotime($outTime)) : ''); ?>" step="60" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <select class="form-control form-control-sm status-select" name="rows[<?php echo e($i); ?>][status]" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                                    ...
                                                    <td>
                                                        <?php if(!empty($statusVal) || !empty($inTime) || !empty($outTime)): ?>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-outline-danger reset-row" <?php if($holidayLock): ?> disabled <?php endif; ?>>Reset</button>
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                        ...
                        <div class="tab-pane fade <?php echo e(($activeTab ?? 'students') === 'staff' ? 'show active' : ''); ?>" id="staff" role="tabpanel">
                            <form method="post" action="<?php echo e(url('attendance/mark?tab=staff&date='.$selectedDate.'&role_id='.request('role_id'))); ?>">
                                ...
                                <select id="staffRoleFilter" name="role_id" class="form-control form-control-sm select2 att-filter" style="width:220px;">
                                    ...
                                    <input type="hidden" name="role_id" id="roleFilterInput" value="<?php echo e(request('role_id')); ?>">
                                <div class="ml-auto d-flex align-items-center att-actions" style="gap:10px;">
                                    <div class="att-field">
                                        <label>Bulk Check In</label>
                                        <input type="time" id="bulkInStaff" class="form-control form-control-sm att-time att-time-input" step="60" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                    </div>
                                    <div class="att-field">
                                        <label>Bulk Check Out</label>
                                        <input type="time" id="bulkOutStaff" class="form-control form-control-sm att-time att-time-input" step="60" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                    </div>
                                    <div class="att-field">
                                        <label>&nbsp;</label>
                                        <button class="btn btn-sm btn-outline-secondary" type="button" id="applyBulkTimeStaff" <?php if($holidayLock): ?> disabled <?php endif; ?>>Apply Time</button>
                                    </div>
                                    <div class="att-field">
                                        <label>Bulk Status</label>
                                        <select id="bulkStatusStaff" class="form-control form-control-sm att-filter" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                        <option value="">Bulk Status</option>
                                        <option value="present">Present</option>
                                        <option value="absent">Absent</option>
                                        <option value="leave">Leave</option>
                                    ...
                                    <div class="att-field">
                                        <label>&nbsp;</label>
                                        <button class="btn btn-sm btn-outline-secondary" type="button" id="applyBulkStaff" <?php if($holidayLock): ?> disabled <?php endif; ?>>Apply Status</button>
                                    </div>
                                    <div class="att-field">
                                        <label>&nbsp;</label>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    ...
                                                    $statusVal = $mark->status ?? '';
                                                ?>
                                                <tr class="staff-row" data-role="<?php echo e($member->role_id); ?>">
                                                    <td><?php echo e($uniqueId); ?></td>
                                                    <td><?php echo e(trim($member->first_name . ' ' . $member->last_name)); ?></td>
                                                    <td>
                                                        <input type="time" class="form-control form-control-sm att-time-input" name="rows[<?php echo e($i); ?>][in_time]" value="<?php echo e($staffIn ? date('H:i', strtotime($staffIn)) : ''); ?>" step="60" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                                    </td>
                                                    <td>
                                                        <input type="time" class="form-control form-control-sm att-time-input" name="rows[<?php echo e($i); ?>][out_time]" value="<?php echo e($staffOut ? date('H:i', strtotime($staffOut)) : ''); ?>" step="60" <?php if($holidayLock): ?> disabled <?php endif; ?>>
                                                    </td>
                                                    <td>
                                                        <input type="hidden" name="rows[<?php echo e($i); ?>][unique_id]" value="<?php echo e($uniqueId); ?>">
                                                    ...
                                                    <td>
                                                        <?php if(!empty($statusVal) || !empty($staffIn) || !empty($staffOut)): ?>
                                                            <span class="att-status-badge" style="background:#d1f7e6;color:#0f5132;">Marked</span>
                                                        <?php else: ?>
                                                            <span class="att-status-badge">Not marked yet</span>
                                                        <?php endif; ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/attendance/biometric.blade.php ENDPATH**/ ?>