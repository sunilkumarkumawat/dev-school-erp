    ...
    <section class="content pt-3">
        <div class="container-fluid">
            <div class="card card-outline card-orange">
                ...
                <div class="card-body">
                    <form method="get" action="<?php echo e(url('attendance/add_weekend')); ?>" class="mb-3">
                        <div class="row g-2">
                            <div class="col-md-2">
                                <select name="month" class="form-control form-control-sm">
                                    <?php for($m=1;$m<=12;$m++): ?>
                                        <option value="<?php echo e($m); ?>" <?php echo e($calendarMonth === $m ? 'selected' : ''); ?>><?php echo e(date('M', mktime(0,0,0,$m,1))); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                                <select name="year" class="form-control form-control-sm">
                                    <?php for($y=date('Y')-2;$y<=date('Y')+2;$y++): ?>
                                        <option value="<?php echo e($y); ?>" <?php echo e($calendarYear === $y ? 'selected' : ''); ?>><?php echo e($y); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="att-calendar-grid">
                        <?php for($i=0;$i<42;$i++): ?>
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                <div class="att-day <?php echo e($cls); ?>" data-date="<?php echo e($dateStr); ?>">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong><?php echo e($day); ?></strong>
                                        <?php if(count($dayEvents) > 0): ?>
                                            <span class="badge badge-dark"><?php echo e(count($dayEvents)); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="event-list-mini">
                                        <?php $__currentLoopData = array_slice($dayEvents, 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="event-chip"><?php echo e($ev['attendance_status_name'] ?: 'Status'); ?> - <?php echo e(($ev['event_title'] ?? '') ?: ($ev['event_schedule'] ?? '')); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(count($dayEvents) > 2): ?>
                                            <div class="event-chip muted">+<?php echo e(count($dayEvents) - 2); ?> more</div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endif; ?>
...
<script>
$(function() {
    var eventsByDate = <?php echo json_encode($eventsPayload, 15, 512) ?>;
    var selectedDate = '';
    var selectedEventId = '';
    ...
    $('#saveCalendarEvent').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(url('attendance/add_weekend')); ?>',
            type: 'POST',
            data: payload,
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/master/Weekendcalendar/add.blade.php ENDPATH**/ ?>