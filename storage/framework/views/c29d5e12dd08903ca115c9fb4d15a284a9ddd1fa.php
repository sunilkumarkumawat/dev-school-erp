                    ...
                    <div class="col-md-10">
                       <div class="card">
                           <div class="card-body pl-0 pr-0 pt-2 pb-2">
                                            ...
                                            <p class="text-danger font-weight-bold ">Full Payment assign to <?php echo e(__('common.Class')); ?> :-</p>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped dataTable dtr-inline padding_table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th><input type="checkbox" id="select_group" checked for="select_group"> <label for="select_group"><?php echo e(__('Select All')); ?></label></th>
                                        ...
                                        <tbody>
                                            <?php if(!empty($getFeesGroup)): ?>
                                                ...
                                                <?php $__currentLoopData = $getFeesGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td> <?php echo e($i++); ?></td>
                                                        <td> <input type="checkbox" class="group_checkbox" id="fees_group_id" name="fees_group_id[]" value="<?php echo e($type->id ?? ''); ?>" checked></td>
...
unset($__errorArgs, $__bag); ?>" type="text" name="amount[<?php echo e($type->id ?? ''); ?>]" id="amount" placeholder="Amount" value="0" onkeypress="javascript:return isNumber(event)">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="date" name="installment_due_date[<?php echo e($type->id ?? ''); ?>]">
                                                        </td>
                                                        <td>
                                                            <input class="form-control change_box" data-amount_id="0" type="checkbox" name="editable[<?php echo e($type->id ?? ''); ?>]" id="editable">
                                                            <input type="hidden" name="editable_value[<?php echo e($type->id ?? ''); ?>]" class="close_edited_value" id="editable_value" value="0">
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
           ...
           <div class="col-md-12  text-left"> 
            ...
            <div class="row m-2">
                    <div class="col-md-12">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <lable><?php echo e(__('common.Class')); ?></lable>
                  ...
                  <tbody id="">
                    ...
                    <tr class="all_data" data-class="<?php echo e($item->class_type_id); ?>">
                     ...
                     ?>
                        ...
                        <a href="javascript:;" data-groupname='<?php echo e($mydata->id ?? ''); ?>' data-bs-toggle="modal" data-bs-target="#Modal_id" class="deleteData <?php echo e(Helper::permissioncheck(11)->delete ? '' : 'd-none'); ?>"><i class="fa fa-remove text-danger" title="Delete"></i></a>
                      ...
                      <td>
                        <a href="<?php echo e(url('feesMasterEdit')); ?>/<?php echo e($item['class_type_id'] ?? ''); ?>" class="text-success tooltip1 <?php echo e(Helper::permissioncheck(11)->edit ? '' : 'd-none'); ?>" title1="Edit"><i class="fa fa-edit pl-2"></i></a>
                      </td>
                ...
                <div class="modal-body">
                    <form id="feesForm" class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label for="class" class="form-label"><?php echo e(__('common.Class')); ?></label>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary">
                <h4 class="modal-title">Assign Installment Payment to Students for the selected <?php echo e(__('common.Class')); ?></h4>
            </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rusofterp/public_html/dev/resources/views/fees/fees_master/feesMaster.blade.php ENDPATH**/ ?>