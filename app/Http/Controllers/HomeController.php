    ...
    public function subjectGetData(Request $request, $id){ 
        ...
        if(!empty($id)){
              ...
              if(Session::get('role_id') == 2)
            {
                 ...
                 $subjects = TeacherSubject::where('session_id',Session::get('session_id'))->where('branch_id',Session::get('branch_id'))->where('user_id', Session::get('id'))->where('class_type_id', $id)->groupBy('subject_id')->get();
            ...
            $subject = $subject->where('session_id',Session::get('session_id'))->where('branch_id',Session::get('branch_id'))->get();
