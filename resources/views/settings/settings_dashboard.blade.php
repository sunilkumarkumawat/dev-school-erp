                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-graduation-cap"></i> &nbsp;{{ __('Setting Management') }}</h3>
                   ...
                   @if(!empty(Helper::SidebarSubPerm(17)))
                        @foreach(Helper::SidebarSubPerm(17) as $sub_sidebar)
