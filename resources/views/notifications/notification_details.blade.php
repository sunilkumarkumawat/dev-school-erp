            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10 col-12">
                    ...
                    <div class="card shadow-lg border-0 rounded-3" style="overflow:hidden;">
                        ...
                        {{-- Body --}}
                        <div class="card-body" style="background:#f5f8ff; padding:2rem;">
                            {{-- Title --}}
                            <div class="mb-3">
                            ...
                            {{-- Content --}}
                            <div class="p-3 mb-3 bg-white border-start border-4 border-primary shadow-sm rounded-3" 
                            ...
                            @if(!empty($notification->image))
                                <div class="text-center mt-4">
                                    <div class="p-2 border rounded-3 bg-white shadow-sm d-inline-block">
