                                    ...
                                    @endphp
                                        ...
                                        <tr>
                                           ...
                                           <!--<td>{{ $item['type'] ??'' }}</td>-->
                                            ...
                                            <td>
                                    <a href="{{url('messExpanceEdit',$item->id)}}" class="btn btn-primary  btn-xs ml-3 tooltip1" title1="Edit Student Registration"><i class="fa fa-edit"></i></a>
                                    <a href="javascript:;"  data-id='{{$item->id}}' data-bs-toggle="modal" data-bs-target="#Modal_id"  class="deleteData btn btn-danger  btn-xs ml-3 tooltip1" title1="Delete Student Registration"><i class="fa fa-trash-o"></i></a>  
