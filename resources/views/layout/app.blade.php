...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{ env('IMAGE_SHOW_PATH').'setting/left_logo/'.$setting->left_logo }}" onerror="this.src='{{ env('IMAGE_SHOW_PATH').'/default/no_image.png' }}'" width="42px" height="42px">
       ...
       <script src="{{URL::asset('public/assets/school/js/pace.min.js')}}"></script>
       <link rel="stylesheet" href="{{ asset('public/assets/school/css/pace-theme-minimal.css') }}">
    </head>
    <style>
