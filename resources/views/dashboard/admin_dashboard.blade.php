    ...
    <section class="content pt-3">
        <div class="container-fluid">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <div class="row g-2 align-items-center mb-2">
                              <div class="col-auto">
                                <div class="icon-box" style="background-color:#4fa5e94d;">
                                      <img src="{{ env('IMAGE_SHOW_PATH') . '/icons/student2.png' }}" alt="bg_logo" width="100%">
                                  <!--<i class="fa fa-users" aria-hidden="true"></i>-->
                                </div>
                              </div>
                              <div class="col">
                                   <a href="{{ url('admissionView') }}" class="small-box-footer">
                                <div class="title">Total Students Enrolled</div>
                                   </a>
                                <div class="subtitle">कुल छात्र संख्या</div>
                              </div>
                            </div> 
                            <div class="total-count">{{App\Models\Admission::countActiveAdmission()->count()}}</div>
                            <div class="row label-row">
                              <div class="col">Male Students:</div>
                              <div class="col text-right fw-bold">{{ \App\Models\Admission::countActiveAdmission()->where('gender_id', 1)->count() }}</div>
                            </div>
                            <div class="row label-row">
                              <div class="col">Female Students:</div>
                              <div class="col text-right fw-bold">{{ \App\Models\Admission::countActiveAdmission()->where('gender_id', 2)->count() }}</div>
                            </div>
                            <div class="row label-row">
                              <div class="col">Occupancy Rate:</div>
                              <div class="col text-right occupancy">{{$occupancy}}%</div>
                            </div>
                          </div>
                        </div>
                   ...
                   @php
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                      <div class="card-custom">
                        <div class="row g-2 align-items-center mb-2">
                          <div class="col-auto">
                            <div class="icon-box" style="background-color:#378b4e2e">
                              <img src="{{ env('IMAGE_SHOW_PATH') . '/icons/attendence2.png' }}" alt="bg_logo" width="100%">
                            </div>
                          </div>
                          <div class="col">
                        ...
                        <div class="total-count text-success">{{ \App\Models\StudentAttendance::countPresentStudents()->count() }}</div>
                    
                        <div class="row label-row">
                          <div class="col">Present Students :</div>
                          <div class="col text-right fw-bold text-success">{{ $present }}</div>
                        </div>
                    
                        <div class="row label-row">
                          <div class="col">Absent Students:</div>
                          <div class="col text-right fw-bold text-warning">{{ $absent }}</div>
                        </div>
                    
                        <div class="row label-row">
                          <div class="col"> Remaining (No Entry):</div>
                          <div class="col text-right occupancy text-danger">{{ $remaningstudent }}</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                      <div class="card-custom">
                        <div class="row g-2 align-items-center mb-2">
                          <div class="col-auto">
                            <div class="icon-box" style="background-color:#4fa5e94d;">
                              <img src="{{ env('IMAGE_SHOW_PATH') . '/icons/fees2.png' }}" alt="bg_logo" width="100%">
                            </div>
                          </div>
                          <div class="col">
                            <a href="{{ url('studentsAttendanceView') }}" class="small-box-footer">
                        ...
                        <div class="total-count">₹ {{ number_format($totalAssigned, 2) }}</div>
                    
                        <div class="row label-row">
                          <div class="col">Paid:</div>
                          <div class="col text-right fw-bold text-success">₹ {{ number_format($totalCollected, 2) }}</div>
                        </div>
                    
                        <div class="row label-row">
                          <div class="col">Pending:</div>
                          <div class="col text-right fw-bold text-warning">₹ {{ number_format($totalPending, 2) }}</div>
                        </div>
                    
                        <div class="row label-row">
                          <div class="col">Status:</div>
                          <div class="col text-right occupancy">
                            <span class="status-badge {{ $collectionPercent >= 80 ? 'bg-success' : ($collectionPercent >= 50 ? 'bg-warning' : 'bg-danger') }} text-white">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                  <form id="todayCollectionForm" action="{{ url('fees/index') }}" method="post">
                    @csrf
                    <input type="hidden" name="starting" value="{{ date('Y-m-d') }}">
                    <input type="hidden" name="ending" value="{{ date('Y-m-d') }}">
                    ...
                    <div class="card-custom" onclick="document.getElementById('todayCollectionForm').submit();">
                      ...
                      <div class="total-count text-primary">₹ {{ number_format($todayCollection, 2) }}</div>
                      ...
                      <div class="row label-row">
                        ...
                        <div class="col text-right occupancy">
                          <span class="status-badge {{ $collectionPercent >= 80 ? 'bg-success' : ($collectionPercent >= 50 ? 'bg-warning' : 'bg-danger') }} text-white">
                            {{ $collectionPercent }}% Collected Today
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                @php
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                          <form id="expenseForm" action="{{ url('expenseView') }}" method="post">
                            @csrf
                            <input type="hidden" name="starting" value="{{ Carbon::now()->startOfMonth()->format('Y-m-d') }}">
                            <input type="hidden" name="ending" value="{{ Carbon::now()->endOfMonth()->format('Y-m-d') }}">
                        
                            <div class="card-custom" onclick="document.getElementById('expenseForm').submit();">
                              <div class="row g-2 align-items-center mb-2">
                                <div class="col-auto">
                                  <div class="icon-box" style="background-color:#f8d7da;">
                                    <img src="{{ env('IMAGE_SHOW_PATH') . '/icons/expense.png' }}" alt="expense_icon" width="100%">
                                  </div>
                                </div>
                                <div class="col">
                              ...
                              <div class="total-count text-danger">₹ {{ number_format($totalExpense, 2) }}</div>
                        
                              <div class="row label-row">
                                <div class="col">Today's Expense:</div>
                                <div class="col text-right fw-bold text-danger">₹ {{ number_format($todayExpense, 2) }}</div>
                              </div>
                        
                              <div class="row label-row">
                                <div class="col">This Month:</div>
                                <div class="col text-right fw-bold text-warning">₹ {{ number_format($monthExpense, 2) }}</div>
                              </div>
                            ...
                            <div class="row g-2 align-items-center mb-2">
                              <div class="col-auto">
                                <div class="icon-box" style="background-color:#ffdfdf;">
                                  <img src="{{ env('IMAGE_SHOW_PATH') . '/icons/birthday.png' }}" alt="birthday_icon" width="100%">
                                </div>
                              </div>
                              <div class="col">
                            ...
                            @if($getstudentbirthday->count() > 0)
                              <div style="max-height: 100px; overflow-y: auto; padding-right: 5px;">
                                ...
                                <ul class="todo-list ui-sortable" data-widget="todo-list">
                                  @foreach($getstudentbirthday as $student)
                                    <li class="list-group-item py-1 px-2 d-flex justify-content-between align-items-center">
                                      <span>🎉 {{ $student->first_name }} {{ $student->last_name ?? '' }}  •  {{ $student->class_name ?? '' }}</span>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                      <div class="card-custom">
                        <div class="row g-2 align-items-center " style="margin-bottom: 40px;">
                          <div class="col-auto">
                            <div class="icon-box" style="background-color:#d1ecf1;">
                              <img src="{{ env('IMAGE_SHOW_PATH') . '/icons/warden2.png' }}" alt="user_icon" width="100%">
                            </div>
                          </div>
                          <div class="col">
                            <a href="{{ url('viewUser') }}" class="small-box-footer">
                        ...
                        <div class="total-count text-info">{{ $userCount }}</div>
                        ...
                        <div class="row label-row">
                          ...
                          <div class="col text-right fw-bold text-warning">{{0 ?? ''}}</div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                          <div class="card-custom">
                            <div class="row g-2 align-items-center mb-2">
                              <div class="col-auto">
                                <div class="icon-box" style="background-color:#f9ea0126;">
                                  <img src="{{ env('IMAGE_SHOW_PATH') . '/icons/complaint2.png' }}" alt="bg_logo" width="100%">
                                </div>
                              </div>
                              <div class="col">
                                <a href="{{ url('complaint_view') }}" class="small-box-footer">
                            ...
                            <div class="total-count text-danger">{{ $total }}</div>
                        
                            <div class="row label-row">
                              <div class="col">Resolved:</div>
                              <div class="col text-right fw-bold text-success">{{ $resolved }}</div>
                            </div>
                        
                            <div class="row label-row">
                              <div class="col">Pending:</div>
                              <div class="col text-right fw-bold text-warning">{{ $pending }}</div>
                            </div>
                        
                            <div class="row label-row">
                              <div class="col">Status:</div>
                              <div class="col text-right occupancy">
                                <span class="status-badge text-white {{ $statusColor }}">{{ $percent }}% Resolved</span>
                             </div>
                          </div>
                        </div>
            </div>
                            ...
                            <marquee direction="up" scrollamount="4" id="newnotic" onMouseOver="document.all.newnotic.stop()"
                                ...
                                <ul class="todo-list ui-sortable" data-widget="todo-list">
                                   @if(!empty($noticeBoard))
                                    ...
                                    <li class="">
                                      <a href="{{ url('notice_board/viewid') }}/{{$item->id}}">
            ...
            @endif
                ...
                <div class="col-md-12">
                    <div class="card card-dark ">
                        <div class="card-header">
                            <h3 class="card-title"> {{ __('Class-wise Attendance (Grouped)') }} </h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fa fa-minus"></i>
                                </button>
...
<script>
    var labels = {!! json_encode(array_keys($chartAttendanceStudentsClassWise)) !!};

    var datasets = [
        {
            label: 'Present',
            data: {!! json_encode(array_column($chartAttendanceStudentsClassWise, 'in')) !!},
            backgroundColor: '#00a65a'
        },
        {
            label: 'Absent',
            data: {!! json_encode(array_column($chartAttendanceStudentsClassWise, 'Absent')) !!},
            backgroundColor: '#f56954'
        },
        {
            label: 'Holiday',
            data: {!! json_encode(array_column($chartAttendanceStudentsClassWise, 'Holiday')) !!},
            backgroundColor: '#f39c12'
        },
   
        {
            label: 'Event',
            data: {!! json_encode(array_column($chartAttendanceStudentsClassWise, 'Event')) !!},
            backgroundColor: '#5a6268'
        },
        {
            label: 'Exam',
            data: {!! json_encode(array_column($chartAttendanceStudentsClassWise, 'Exam')) !!},
    ...
    $(function () {
        ...
        var donutData = {
            ...
            datasets: [
                {
                    data: [ 
                        {{$chartAttendanceStudents['in']}},
                        {{$chartAttendanceStudents['Absent']}},
                        {{$chartAttendanceStudents['Holiday']}},
                        {{$chartAttendanceStudents['Event']}},
                        {{$chartAttendanceStudents['Exam']}}
                    ],
...
$(document).ready(function() {
    ...
    $('#7_days').click(function() {
        ...
        chartData(@json($data1)); // Load weekly data
        $('.collection').html(`
            <i class="fa fa-money mr-1" aria-hidden="true"></i>
    ...
    $('#monthly').on('click', function() {
        $('#myChart').remove(); // Remove the existing canvas
        $('#chart-container').append('<canvas id="myChart"></canvas>'); // Append a new canvas
        chartData(@json($data)); // Load monthly data
        $('.collection').html(`
            <i class="fa fa-money mr-1" aria-hidden="true"></i>
    ...
    $('#yearly').on('click', function() {
        $('#myChart').remove(); // Remove the existing canvas
        $('#chart-container').append('<canvas id="myChart"></canvas>'); // Append a new canvas
        chartData(@json($data2)); // Load yearly data
        $('.collection').html(`
            <i class="fa fa-money mr-1" aria-hidden="true"></i>
