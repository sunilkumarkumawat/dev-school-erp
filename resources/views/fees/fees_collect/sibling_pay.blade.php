...
<form method="post"
      action="{{ isset($preview) ? route('sibling.confirm') : route('sibling.preview') }}">
@csrf

<input type="hidden" name="ledger_no" value="{{ $ledgerNo }}">
    ...
    <div class="fee-row">
        ...
        <div>
            <input type="checkbox"
                   ...
                   data-group="{{ $group->fees_group_id }}"
                   disabled>
            {{ $group->group_name }}
        </div>
...
<div class="text-center">
    <button type="submit" class="btn btn-success btn-lg">
        {{ isset($preview) ? 'Confirm & Pay' : 'Preview Distribution' }}
    </button>
</div>
