                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 @error('class_type_id') is-invalid @enderror" id="class_type_id" name="class_type_id">
                                                ...
                                                @foreach($classType as $type)
                                                        <option value="{{ $type->id ?? ''  }}" {{ old('class_type_id', $type->id == $search['class_type_id'] ?? '' ) ? 'selected' : '' }}>{{ $type->name ?? ''  }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                @error('class_type_id')
                				...
                				@enderror
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{old('name',$search['name']) ?? ''}}" id="name" name="name" placeholder="{{ __('common.Search By Keywords') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-1 ">
                                        <div class="form-group">
