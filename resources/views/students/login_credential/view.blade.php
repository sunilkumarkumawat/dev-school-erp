                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-sign-in"></i> &nbsp; {{ __('Login Credential') }}
                            </h3>
                            ...
                            <div class="col-md-8">
                                <form id="quickForm" action="{{ url('login_credential_reports') }}" method="post"
                                    ...
                                    <div class="col-md-3 mt-4">
                                        <button type="submit" class="btn btn-primary mt-md-1">{{ __('common.Search')
                                            }}</button>
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <tr>
                                            <td style="width:100px;">
                                                <div class="d-flex align-items-center gap-2">
                                                    <input type="checkbox" class="student_checkbox" value="{{ $item->id }}">
