                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-graduation-cap"></i> &nbsp;{{ __('Qr Code Dashboard') }}</h3>
                   ...
                   @if(!empty(Helper::SidebarSubPerm(25)))
                        @foreach(Helper::SidebarSubPerm(25) as $sub_sidebar)
