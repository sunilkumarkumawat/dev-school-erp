            ...
            <div class="profile-main-card">
                ...
                <div class="profile-grid">
                    ...
                    <div class="profile-photo-box">
                        <img src="{{ env('IMAGE_SHOW_PATH') . '/profile/' . $getUser['image'] }}"
                        ...
                        <div class="profile-top">
                            <div>
                                ...
                                <div class="badges">
                                    ...
                                    <span class="badge gray">{{ $getUser['category'] }}</span>
                                </div>
                            </div>
                            ...
                            <form action="{{ url('studentDetail') }}" method="post">
                                ...
                                <div class="row pt-2">
                                    ...
                                    <div class="col-md-2 col-4">
                                        <button type="submit" name="session_id" value="{{ $stuSession->id ?? '' }}"
                                            class="btn @if ($stuSession->id == Session::get('session_id')) btn-primary @else btn-light @endif">{{
                                            $stuSession->from_year ?? '' }}
                                            - {{ $stuSession->to_year ?? '' }}</button>
                                    </div>
                                    @endforeach
                                    @endif
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="listing_tab tabs-custom">
                                        <ul class="nav-tabs">
                                            ...
                                            <li class="get_data getFees" data-id="{{ $getUser->id ?? '' }}"
                                            ...
                                            {{-- <li class="get_data" data-title="edit_profile"
                                                data-target="edit_profile">
                                                <a href="#edit_profile" class="get_data1"><i
                                                        class="fa fa-pencil-square-o p-1" aria-hidden="true"></i> Edit
                                                    Profile</a>
                                            </li> --}}
                                        </ul>
                                    </div>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        ...
                                                        <strong>{{ $getUser->from_year ?? '' }} - {{ $getUser->to_year
                                                            ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        ...
                                                        <strong>{{ $getUser->admissionNo ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        ...
                                                        <strong>{{ $getUser->admission_date ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        <span>Class</span>
                                                        <strong>{{ $getUser->class_name ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        <span>Category</span>
                                                        <strong>{{ $getUser->category ?? '' }}</strong>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        ...
                                                        <strong>{{ $getUser->first_name ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        <span>Gender</span>
                                                        <strong>{{ $getUser->genderName ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        ...
                                                        <strong>{{ $getUser->blood_group ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        ...
                                                        <strong>{{ $getUser->mother_tongue ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        <span>Religion</span>
                                                        <strong>{{ $getUser->religion ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        <span>Caste</span>
                                                        <strong>{{ $getUser->caste_category ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        <span>City</span>
                                                        <strong>{{ $getUser->city_name ?? '' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-sm-6 mb-3">
                                                    <div class="info-box-sm">
                                                        <span>State</span>
                                                        <strong>{{ $getUser->state_name ?? '' }}</strong>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="profile-section">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table promotion-table">
                                                    ...
                                                    <tbody>
                                                        @forelse ($promotion_history as $key => $student)
                                                        <tr>
                                                            <td>
                                                                <span class="count-badge">{{ $key + 1 }}</span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                {{
                                                                \Carbon\Carbon::parse($student->admission_date)->format('d
                                                                M, Y') }}
                                                            </td>
                                                        </tr>
                                                        @empty
                                            ...
                                            <div class="table-responsive">
                                                <table class="table fees-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><span class="count-badge">{{ $i++ }}</span></td>
                                                            ...
                                                            <td>
                                                                @if($item->fees_group_amount > $pad)
                                                                <span class="status unpaid">Unpaid</span>
                                                                @else
                                                                <span class="status paid">Paid</span>
                                                                @endif
                                                            </td>
                                                            <td>{{ $item->fees_group_amount }}</td>
                                                            <td>{{ $discount }}</td>
                                                            <td>{{ $fine_amt }}</td>
                                                            <td>{{ $pad }}</td>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-4 col-sm-6">
                                                    <div class="fees-card total">
                                                        ...
                                                        <strong>{{ $getUser->guardian_name ?? '—' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 col-sm-6">
                                                    <div class="fees-card paid">
                                                        <span>Relation</span>
                                                        <strong>{{ $getUser->relation_student ?? '—' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 col-sm-6">
                                                    <div class="fees-card discount">
                                                        <span>Mobile No</span>
                                                        <strong>{{ $getUser->father_mobile ?? '—' }}</strong>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <table class="table fees-table">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>{{ $getUser->mother_name ?? '—' }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td><strong>Occupation</strong></td>
                                                            <td>{{ $getUser->father_occupation ?? '—' }}</td>

                                                            <td><strong>Education</strong></td>
                                                            <td>{{ $getUser->father_education ?? '—' }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td><strong>Annual Income</strong></td>
                                                            <td>{{ $getUser->family_annual_income ?? '—' }}</td>

                                                            <td><strong>Email</strong></td>
                                                            <td>{{ $getUser->father_gmail ?? '—' }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="table fees-table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3">{{ $getUser->address ?? '—' }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td><strong>Guardian Photo</strong></td>
                                                            <td colspan="3">
                                                                <img src="{{ env('IMAGE_SHOW_PATH') . '/father_image/' . $getUser['father_img'] }}"
                                                                    onerror="this.src='{{ env('IMAGE_SHOW_PATH') . '/default/user_image.jpg' }}'"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div style="display:flex;align-items:center;gap:10px;">
                                                                    <img src="{{ env('IMAGE_SHOW_PATH') . '/profile/' . $sibling['image'] }}"
                                                                        onerror="this.src='{{ env('IMAGE_SHOW_PATH') . '/default/user_image.jpg' }}'"
                                    ...
                                    <div class="container mt-4 tabData w-100" id="documents"
                                        ...
                                        <div id="addStaffDocuments" class="modal"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ url('document_upload') }}/{{$getUser['id']}}"
                                        ...
                                        <table class="table promotion-table documents-table">
                                            ...
                                            <tbody>
                                                ...
                                                @forelse($getDocuments as $key => $document)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    ...
                                                    <td>
                                                        <div style="display:flex;align-items:center;gap:10px;">
                                                            <img class="profile-user-img img-fluid img_frame"
                                                                src="{{ env('IMAGE_SHOW_PATH') . '/student_document/' . $document['file'] }}"
                                                    ...
                                                    <td>
                                                        <a href="{{ env('IMAGE_SHOW_PATH') . '/student_document/' . $document['file'] }}"
            ...
            <form action="#" method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary waves-effect waves-light change_status1"
                        data-bs-dismiss="modal">{{ __('common.Yes') }}</button>
