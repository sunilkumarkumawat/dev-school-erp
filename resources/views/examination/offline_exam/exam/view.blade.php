							...
							<table id="example1" class="table table-bordered table-striped  dataTable">
								<thead>
									<tr role="row">
										...
										<th>{{ __('examination.Description') }}</th>
								...
								@foreach ($data as $item)
									...
									<tr>
							           ...
							           <td>
                                            <a href="{{url('assign/exam') }}/{{$item->id}}" class="btn btn-success btn-xs ml-3 tooltip1" title1="Assign Exam to Class" title="Assign Exam to Class"><i class="fa fa-tag"></i></a>
                                            <a href="{{url('edit/exam') }}/{{$item->id}}" class="btn btn-primary  btn-xs ml-3 tooltip1" title1="Edit Exam" title="Edit Exam"><i class="fa fa-edit"></i></a> 
											<a href="javascript:;" data-id='{{$item->id}}' data-bs-toggle="modal" data-bs-target="#Modal_id" class="deleteData btn btn-danger  btn-xs ml-3 tooltip1" title1="Delete" title="Delete Exam"><i class="fa fa-trash-o"></i></a> 
										</td>
