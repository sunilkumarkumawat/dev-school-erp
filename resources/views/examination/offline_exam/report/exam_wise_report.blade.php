         ...
         <div class="col-12 col-md-12">
            <div class="card card-outline card-orange">
               <div class="card-header bg-primary">
                  <h3 class="card-title"><i class="fa fa-leanpub"></i> &nbsp; {{ __('Exam Wise Report') }} </h3>
               ...
               <div class="card-body">
                     <div class="row">
                        <div class='col-md-10'>
                        <form id="quickForm_find" action="{{ url('exam_wise_report') }}" method="post" target="_blank">
                             @csrf 
                            <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                               <div class="form-group">
                                  ...
                                  <select class="select2 form-control " id="subject_id" name="subject_id[]" multiple="">
                                     <option value="">{{ __('messages.Select') }}</option>
                                     </select>
                               </div>
                            </div>
