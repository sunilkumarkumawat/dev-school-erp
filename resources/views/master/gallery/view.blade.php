                    ...
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="{{url('gallery_add')}}" class="btn btn-primary  btn-sm {{ Helper::permissioncheck(9)->add ? '' : 'd-none' }}" title="Add Gallary"><i class="fa fa-plus"></i>{{ __('Add Gallary') }}</a>
                                @endif
                                 @if(Session::get('role_id') == 1)
        ...
        <div class="row mt-3">
            @foreach($gallery_details as $data)
                 <div class="col-md-2">
                                    ...
                                    <div class="edit_gallery_overley_div">
                                       <a href="{{url('gallery_edit')}}/{{$data->id}}" class="{{ Helper::permissioncheck(9)->edit ? '' : 'd-none' }}"><button class="btn btn-primary Edit_Text ">{{__('common.Edit') }}</button></a>
                                       <a><button class="delete_btn btn btn-danger ml-2 Edit_Text {{ Helper::permissioncheck(9)->delete ? '' : 'd-none' }}" data-id="{{$data->id}}" data-toggle="modal" data-target="#deleteModal">{{__('common.Delete') }}</button></a>
                                    </div>
