                ...
                <div class="row m-2">
                     <div class="col-md-2">
                        ...
                        <label for="inputEmail3"> Invoice/Bill No.</label>
                         <input type="text" class="form-control @error('invoice_no') is-invalid @enderror"  id="invoice_no"  name="invoice_no"  value="{{$invoice_no ?? ''}}" placeholder="Invoice No." >
        					@error('invoice_no')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <span class="input-group-append">
                                ...
                                <input id="student_name" type="text" class="form-control" autofocus="autofocus" name="student_name"  value="{{old('party_name') ?? ''}}" placeholder="Student Name" style="height: 35px;" required>
                                @error('student_name')
        						<span class="invalid-feedback" role="alert">
        							<strong>{{ $message }}</strong>
        						</span>
