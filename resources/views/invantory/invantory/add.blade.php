                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label style="color:red;">To (Party Name)*</label>
                                <input id="party_name1" type="text" class="form-control @error('party_name') is-invalid @enderror"  name="party_name"  value="{{old('party_name') ?? ''}}" placeholder="Party Name" style="height: 35px;" >
                        </div>
                    </div>
                    <div class="col-md-3">
                            <div class="form-group ">
