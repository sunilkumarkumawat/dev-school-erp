            ...
            <div class="card card-outline card-orange self-card">
                ...
                <div class="card-body">
                    ...
                    <div class="self-stats-grid mt-2 mb-2">
                        ...
                        <div class="self-stat-card"><div class="label">Present</div><div class="value text-success" id="stat_present">{{ $presentCount }}</div></div>
                        <div class="self-stat-card"><div class="label">Absent</div><div class="value text-danger" id="stat_absent">{{ $absentCount }}</div></div>
                        <div class="self-stat-card"><div class="label">Leave</div><div class="value text-warning" id="stat_leave">{{ $leaveCount }}</div></div>
                        <div class="self-stat-card"><div class="label">Late</div><div class="value" id="stat_late">{{ $lateCount }}</div></div>
                        <div class="self-stat-card"><div class="label">Early Out</div><div class="value" id="stat_early_out">{{ $earlyOutCount }}</div></div>
                        <div class="self-stat-card"><div class="label">Halfday</div><div class="value" id="stat_halfday">{{ $halfdayCount }}</div></div>
