                ...
                <div class="col-12">
                    <div class="card card-outline card-orange">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-7">
                                    <form action="{{ url('attendance/settings') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="attendance-card mb-3">
                                            ...
                                            <div class="attendance-inline">
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input" type="radio" id="type_biometric" name="attendance_type" value="1" {{ $attendanceType == 1 ? 'checked' : '' }}>
                                                    <label for="type_biometric" class="custom-control-label">Biometric</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input" type="radio" id="type_normal" name="attendance_type" value="2" {{ $attendanceType == 2 ? 'checked' : '' }}>
                                        ...
                                        <div class="attendance-card mb-3">
                                            ...
                                            <div class="attendance-inline">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" id="msg_whatsapp" name="messaging_services[]" value="whatsapp" {{ in_array('whatsapp', $messagingServices, true) ? 'checked' : '' }}>
                                                    <label for="msg_whatsapp" class="custom-control-label">WhatsApp</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" id="msg_firebase" name="messaging_services[]" value="firebase" {{ in_array('firebase', $messagingServices, true) ? 'checked' : '' }}>
                                                    <label for="msg_firebase" class="custom-control-label">Firebase</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" id="msg_sms" name="messaging_services[]" value="sms" {{ in_array('sms', $messagingServices, true) ? 'checked' : '' }}>
                                        ...
                                        <div class="attendance-card mb-3">
                                            ...
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="manual_attendance_messaging_enabled" name="manual_attendance_messaging_enabled" value="1" {{ $manualAttendanceMessagingEnabled === 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="attendance-card mb-3">
                                            ...
                                            <div class="custom-control custom-switch mb-2">
                                                <input type="checkbox" class="custom-control-input" id="auto_absent_mark_enabled" name="auto_absent_mark_enabled" value="1" {{ $autoAbsentMarkEnabled === 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="time" name="auto_absent_mark_time" class="form-control" value="{{ $timeVal('auto_absent_mark_time') }}">
                                        ...
                                        <div class="attendance-card mb-3">
                                            ...
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="allow_back_date_attendance" name="allow_back_date_attendance" value="1" {{ $allowBackDate === 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="late_grace_minutes" class="form-control" value="{{ old('late_grace_minutes', $setting->late_grace_minutes ?? 15) }}" min="0">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>QR Validity (Minutes)</label>
                                                    <input type="number" name="qr_validity_minutes" class="form-control" value="{{ old('qr_validity_minutes', $setting->qr_validity_minutes ?? 5) }}" min="0">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Early Out Grace (Minutes)</label>
                                                    <input type="number" name="early_out_grace_minutes" class="form-control" value="{{ old('early_out_grace_minutes', $setting->early_out_grace_minutes ?? 15) }}" min="0">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Half Day If Working Minutes Less Than</label>
                                                    <input type="number" name="half_day_min_minutes" class="form-control" value="{{ old('half_day_min_minutes', $setting->half_day_min_minutes ?? 240) }}" min="0">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" name="summer_start_time" class="form-control" value="{{ $timeVal('summer_start_time') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Summer End Time</label>
                                                        <input type="time" name="summer_end_time" class="form-control" value="{{ $timeVal('summer_end_time') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Winter Start Time</label>
                                                        <input type="time" name="winter_start_time" class="form-control" value="{{ $timeVal('winter_start_time') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Winter End Time</label>
                                                        <input type="time" name="winter_end_time" class="form-control" value="{{ $timeVal('winter_end_time') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" name="summer_lunch_from_time" class="form-control" value="{{ $timeVal('summer_lunch_from_time') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Summer Lunch To</label>
                                                        <input type="time" name="summer_lunch_to_time" class="form-control" value="{{ $timeVal('summer_lunch_to_time') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" name="winter_lunch_from_time" class="form-control" value="{{ $timeVal('winter_lunch_from_time') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Winter Lunch To</label>
                                                        <input type="time" name="winter_lunch_to_time" class="form-control" value="{{ $timeVal('winter_lunch_to_time') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Notes</label>
                                            <textarea name="notes" rows="3" class="form-control" placeholder="Any special instructions...">{{ old('notes', $setting->notes ?? '') }}</textarea>
                                        </div>
